...
<template>
  <div class="card p-6">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      <!-- Name -->
      <div>
        <label for="name" class="block text-sm font-medium text-dark-300 mb-1">Name</label>
        <input
          id="name"
          v-model="form.name"
          type="text"
      ...
      <!-- Confirm Password -->
      <div>
        <label for="password_confirmation" class="block text-sm font-medium text-dark-300 mb-1">Confirm Password</label>
        <input
